...
import { contentAltaTension } from '../../content';
...
export default function Index() {
  ...
  const {hero, beneficios, alianzas, atributos, catalogo, garantias, testimonios, faqs, cta} = contentAltaTension;
    ...
    <>
      ...
      <section
        ...
        <div className="container md:text-white w-full text-left z-20 py-20">
          <h1 className="md:w-2/3 relative ft-9 md:[text-shadow:_2px_2px_0_rgb(0_0_0_/_40%)]"
